...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    // Must exceed the plane's corner radius (planeScale * sqrt(2)) or the mask
    // culls everything outside a small disc and the field never fills the frame.
    const revealFactor = easedProgress * (planeScale * 1.55);
